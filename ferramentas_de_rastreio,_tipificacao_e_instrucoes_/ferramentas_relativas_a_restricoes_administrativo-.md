## Ferramentas relativas a restrições administrativo-legais e ambientais {#ferramentas-relativas-a-restri-es-administrativo-legais-e-ambientais}
...
Tabela 14 – Informações adicionais sobre a análise, emissão de parecer e recomendações nos casos de restrições administrativo-legais e ambientais

|  | SITUAÇÃO | Sobreposição entre as áreas de proteção turística especial \(ZDTI/ZRPT\) ou áreas de expansão urbana/rural e as áreas incluídas na Rede Nacional de Áreas Protegidas |
| :--- | :--- | :--- |
| AÇÕES | MEDIDA RECOMENDADA | ASSINALAR NO LMITS |
| Verificar os limites das áreas protegidas existentes no território; | Se for uma área com categoria de reserva integral, parcial ou temporal, analisar o melhor cenário a propor juntamente com as entidades competentes. | 1.Uso atual ou previsto é compatível com a categoria da área protegida e/ou objetivos de gestão |
| Verificar se os usos previstos para a zona são compatíveis com os objetivos de conservação; | - Regularização da situação de desconformidade com base em informação relevante que habilite a ponderação de interesses económicos, sociais e ambientais em presença, devendo-se todavia, sempre assegurar o disposto nos artigos 14º e 17º do Decreto-Lei nº 3/2003, de 24 de Fevereiro. A informação deve ser fornecida pelas entidades competentes | 2. Uso atual ou previsto é incompatível com a categoria da área protegida e/ou objetivos de conservação, mas é possível conciliar perante mudança de uso e/ou limites \(aplicação de medida de mitigação após concertação com as entidades competentes\) |
| Verificar a compatibilidade uso dos solos tendo por base o plano de gestão da área protegida em causa; | Fundamentação, pelas entidades competentes através de um Grupo Técnico de Trabalho, da opção da não deslocalização do prédio para local adequado no mesmo concelho ou nos concelhos vizinhos | 3. Uso atual ou previsto é incompatível com a categoria da área protegida e/os objetivos de gestão, não existindo medida de mitigação possível, prevalecendo o artigo 14º e 17º do DL 3/2003 de 24 de Fevereiro |
| Caso não existam limites definidos ou um plano de gestão, consultar a legislação aplicável, o DL 3/2003 e verificar a categoria da área e as medidas de proteção mínimas previstas na legislação e, eventualmente, na classificação da União Internacional para a Conservação da Natureza \(IUCN\); |  | 4.Uso atual ou previsto é incompatível com a categoria da área protegida e/os objetivos de gestão, não existindo medida de mitigação possível – verifica-se alteração do estatuto e/ou limites da área protegida \(fundamentado pela autoridade competente\) |
|  |  | Nota: - O uso das áreas de ZDTI que se sobrepõem aos espaços naturais protegidos deve obedecer, consoante a categoria das áreas protegidas, o estabelecido nos artigos 14º do Decreto-Lei nº 3/2003, de 24 de Fevereiro. Para os casos de contenda, promover a criação de Grupo Técnico de Trabalho com representantes DNA, CI, SDTIBM e CM para ponderação dos diferentes interesses em presença na área e decisão |

|  | SITUAÇÃO | Reservas Naturais com assentamento humano |
| :--- | :--- | :--- |
| AÇÕES | MEDIDA RECOMENDADA | ASSINALAR NO LMITS |
| Analisar a categoria de reserva \(integral, parcial ou temporal\) | - Recomendar - Regularização dos direitos adquiridos junto da Direção Nacional do Ambiente – MAHOT, instituição mandatada para o efeito; | 1. Uso atual ou previsto é compatível com a categoria da área protegida e/ou objetivos de gestão \(seja porque é anterior ao DL, seja porque os usos são conciliáveis\) |
|  | - Se for uma reserva integral, analisar o melhor cenário a propor juntamente com as entidades competentes. | 2. Uso atual ou previsto é incompatível com a categoria da área protegida e/ou objetivos de conservação, mas é possível conciliar perante mudança de uso e/ou limites \(aplicação de medida de mitigação\) |
|  |  | 3. Uso atual ou previsto é incompatível com a categoria da área protegida e/os objetivos de gestão, não existe medida de mitigação possível, prevalece o artigo 14º e 17º do DL 3/2003 de 24 de Fevereiro |
|  |  | 4. Uso atual ou previsto é incompatível com a categoria da área protegida e/os objetivos de gestão, não existe medida de mitigação possível – verifica-se alteração do estatuto e/ou limites da área protegida \(fundamentado pela autoridade competente\) |

|  | SITUAÇÃO | Assentamento humano em áreas de inundações |
| :--- | :--- | :--- |
| AÇÕES | MEDIDA RECOMENDADA | ASSINALAR NO LMITS |
| - Segundo a Portaria nº 6/2011 as zonas sujeitas a inundações tem as seguintes incompatibilidades de uso: habitacional, aglomerado rural, equipamentos sociais, turismo e atividades económicas; | - Verificar, em conjunto com a equipa técnica da Câmara Municipal, as possíveis medidas de mitigação e/ou as possíveis medidas realojamento / reassentamento \(voluntário ou involuntário\). | 1. Compatibilidade de uso quando o risco potencial é considerado baixo e desde que aprovado pela \(s\) entidade \(s\) competente \(s\) |
|  |  | 2. Incompatibilidade de uso mas é possível reverter desde que aplicadas as medidas de mitigação aprovadas pela \(s\) entidade \(s\) competente \(s\) |
|  |  | 3. Incompatibilidade de uso. Aplicação das possíveis medidas de realojamento / reassentamento |

|  | SITUAÇÃO | Habitações em áreas de declive acentuado |
| :--- | :--- | :--- |
| AÇÕES | MEDIDA RECOMENDADA | ASSINALAR NO LMITS |
| Identificar possíveis medidas de mitigação e/ou as possíveis medidas de realojamento / reassentamento \(voluntário ou involuntário\); | Requerer aconselhamento de um técnico especializado \(engenheiro por exemplo\); | 1. Compatibilidade de uso quando o risco potencial é considerado baixo e desde que aprovado pela \(s\) entidade \(s\) competente \(s\) |
| Assegurar que localização adequada seja a acordada com todas as partes interessadas. | Solicitar parecer técnico da CM ou outra entidade com tutela sobre a área sobre habitações em terrenos com inclinação igual ou superior a 30%. | 2. Incompatibilidade de uso, mas é possível reverter desde que aplicadas as medidas de mitigação aprovadas pela \(s\) entidade \(s\) competente \(s\) |
|  | Verificar, em conjunto com as partes interessadas, as possíveis medidas de mitigação e/ou as possíveis medidas realojamento / reassentamento \(voluntário ou involuntário\). | 3. Incompatibilidade de uso. Aplicação das possíveis medidas de realojamento / reassentamento |

|  | SITUAÇÃO | Ocupação de zonas de servidão públicas \(rodoviária, marítima, aeronáutica, militar\) |
| :--- | :--- | :--- |
| AÇÕES | MEDIDA RECOMENDADA | ASSINALAR NO LMITS |
| Assegurar o cumprimento do estipulado na legislação de acordo com a legislação pertinente: | Contactar as entidades da tutela para eventuais esclarecimentos de casos de exclusão, níveis de servidão e medidas de mitigação previstas; | 1. Uso atual ou previsto é compatível com o estabelecido na legislação |
| DL22/2008 de 30 de Junho, aprova o estatuto das Estradas Nacionais | Solicitar às entidades gestoras as informações relevantes que tiverem sobre a pluralidade de afetações \(suscetíveis de satisfazer várias utilidades públicas compatíveis entre si\) | 2. Uso atual ou previsto é incompatível com o previsto na legislação mas pode ser conciliado mediante a aplicação de medidas de mitigação aprovadas pelas entidades competentes |
| DL 10/2010 de 1 de novembro que estabelece o regime jurídico dos portos, zonas portuárias e terminais | Fundamentação, pelas entidades competentes, da opção de redução das zonas de servidão _non aedificandi_ | 3. Incompatibilidade de uso. Aplicação da legislação \(perante mudança de localização\) |
| DL 18/2009 de 22 de Junho que estabelece o regime geral de servidões aeronáuticas |  |  |
| Decretos que regulamentam as áreas de servidão militar em cada ilha |  |  |

|  | SITUAÇÃO | Orla marítima |
| :--- | :--- | :--- |
| AÇÕES | MEDIDA RECOMENDADA | ASSINALAR NO LMITS |
| Estabelecida uma faixa de 80 metros de largura que pertence ao domínio público marítimo | Contactar as entidades da tutela para identificação de usos compatíveis aplicáveis em função das características, valores e capacidade de acolhida de cada área | 1.Uso atual ou previsto é compatível com a categoria da área protegida e/ou objetivos de gestão |
| Verificar os terrenos de ZRPT \(aqueles que estão abrangidos em uma franja costeira de 1km de comprimento\) |  | 2. Uso atual ou previsto é incompatível com a categoria da área protegida e/ou objetivos de conservação, mas é possível conciliar perante mudança de uso e/ou limites \(aplicação de medida de mitigação após concertação com as entidades competentes\) |
| Verificar a existência de instrumentos de gestão territorial e/ou urbanística que estabeleçam o ordenamento da área em análise e integrar as medidas e condicionantes previstas |  | 3. Uso atual ou previsto é incompatível com a categoria da área protegida e/os objetivos de gestão, não existindo medida de mitigação possível, prevalecendo o artigo 14º e 17º do DL 3/2003 de 24 de Fevereiro |
| Assegurar o respeito do domínio público e o livre acesso às praias. |  |  |
